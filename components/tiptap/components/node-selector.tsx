...
export const NodeSelector: FC<NodeSelectorProps> = ({
  ...
  return (
    <div className="relative h-full">
      <button
        className="flex h-full items-center gap-1 whitespace-nowrap p-2 text-sm font-medium text-stone-200 hover:bg-stone-800 active:bg-stone-800"
          ...
          {items.map((item, index) => (
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="rounded-sm border border-stone-700 p-1">
